...
// <head> so it runs before any analytics loads. Everything starts denied,
// then any stored preference is re-applied immediately. GA still loads (gated
// by consent mode) and sends cookieless modelled hits until consent is
// granted. NOT next/script: must execute synchronously.
