// ============================================================================
// CONSENT — state, persistence and events for the cookie banner + Google
// Consent Mode v2. Ported from the STRETCH group site. Stored in localStorage
// under `consent-preferences`; bumping CONSENT_VERSION invalidates stored
// preferences and re-prompts everyone.
// ============================================================================
