...
//   1. Drop the PDF into  datasheets-private/  (repo root — NOT under public/,
//      the files must never be directly reachable by URL).
//   2. Add or edit an entry below. `file` is the BARE filename of the PDF.
//   3. Commit & push.
//
// Every download is gated: the visitor submits name, role, email, phone and
// city (captured as a lead via /api/datasheet-request) and receives a signed
// 14-day download link by email (/api/datasheet/[slug]). Signed-in portal
// clients get ungated signed links on /portal/documents.
//
...
export type Datasheet = {
  ...
  category: string;
  /** Bare PDF filename inside datasheets-private/, e.g. 'acoustic-stretch-system.pdf'. */
  file: string;
...
export const datasheets: Datasheet[] = [
  ...
  },
  {
    ...
    category: 'Ceiling systems',
    file: 'polyester-stretch-ceiling.pdf',
    format: 'PDF',
    sizeLabel: '341 KB',
    updated: 'Aug 2026',
  },
  ...
  },
  {
    ...
    category: 'Ceiling systems',
    file: 'polyester-non-flammable.pdf',
    format: 'PDF',
    sizeLabel: '327 KB',
    updated: 'Aug 2026',
  },
  // ---- Acoustic ------------------------------------------------------------
  {
    ...
    category: 'Acoustic',
    file: 'acoustic-stretch-system.pdf',
    format: 'PDF',
    sizeLabel: '383 KB',
    updated: 'Aug 2026',
  },
  {
    ...
    category: 'Acoustic',
    file: 'stretch-acoustic-495d.pdf',
    format: 'PDF',
    sizeLabel: '383 KB',
    updated: 'Aug 2026',
  },
  {
    ...
    category: 'Acoustic',
    file: 'stretch-acoustic-705a.pdf',
    format: 'PDF',
    sizeLabel: '358 KB',
    updated: 'Aug 2026',
  },
  {
    ...
    category: 'Acoustic',
    file: 'stretch-acoustic-colours.pdf',
    format: 'PDF',
    sizeLabel: '340 KB',
    updated: 'Aug 2026',
  },
  ...
  },
  {
    ...
    category: 'Acoustic',
    file: 'stretchsound-acoustic-panels.pdf',
    format: 'PDF',
    sizeLabel: '150 KB',
    updated: 'Aug 2026',
  },
  // ---- Light & backlit -----------------------------------------------------
  {
    ...
    file: 'stretch-translucent-307-308-309t.pdf',
    format: 'PDF',
    sizeLabel: '346 KB',
    updated: 'Aug 2026',
  },
  ...
  },
  {
    ...
    category: 'Prefab & accessories',
    file: 'stretch-inspection-hatch.pdf',
    format: 'PDF',
    sizeLabel: '239 KB',
    updated: 'Aug 2026',
  },
  // ---- Specials & outdoor --------------------------------------------------
  {
    ...
    file: 'stretch-invisible-speaker.pdf',
    format: 'PDF',
    sizeLabel: '466 KB',
    updated: 'Aug 2026',
  },
  ...
  },
  {
    ...
    category: 'Profiles & installation details',
    file: 's-bs-pvc-01-installation.pdf',
    format: 'PDF',
    sizeLabel: '48 KB',
    updated: 'Aug 2026',
  },
  {
    ...
    category: 'Profiles & installation details',
    file: 's-bs-f-02-installation.pdf',
    format: 'PDF',
    sizeLabel: '84 KB',
    updated: 'Aug 2026',
  },
  {
    ...
    category: 'Profiles & installation details',
    file: 's-bs-f-02-track-support.pdf',
    format: 'PDF',
    sizeLabel: '57 KB',
    updated: 'Aug 2026',
  },
  {
    ...
    category: 'Profiles & installation details',
    file: 'basic-structure-stretch-ceiling-nl.pdf',
    format: 'PDF',
    sizeLabel: '199 KB',
    updated: 'Aug 2026',
  },
  // ---- Maintenance ---------------------------------------------------------
  {
    ...
    file: 'maintenance-stretch-ceilings-nl.pdf',
    format: 'PDF',
    sizeLabel: '252 KB',
    updated: 'Aug 2026',
  },
