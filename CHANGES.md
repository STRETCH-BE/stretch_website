...
QuinLay logo: `partners/page.tsx` renders the logo tile only once
`public/images/partners/quinlay.png` exists (still to be supplied as a
file — the inline paste cannot be saved).
